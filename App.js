...
const App = () => {
  ...
  const fetchCityData = async inputValue => {
    const url = `https://api.openweathermap.org/data/2.5/weather?q=${inputValue}&appid=c8c4865b1ee49f77a87780ffabb644b3&units=metric`
  ...
  return (
    <View style={styles.container}>
      ...
      <Form onChangeText={text => setInputValue(text)} onSubmit={fetchData} />
      <Content temp={temp} city={inputValue} weather={weather} />
